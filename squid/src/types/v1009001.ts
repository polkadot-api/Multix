...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        Society: SocietyCall,
        Staking: StakingCall,
        StakingAhClient: StakingAhClientCall,
        System: SystemCall,
...
export type Type_479 = Type_479_AliasOrigin | Type_479_BurnAsset | Type_479_BuyExecution | Type_479_ClaimAsset | Type_479_ClearError | Type_479_ClearOrigin | Type_479_ClearTopic | Type_479_ClearTransactStatus | Type_479_DepositAsset | Type_479_DepositReserveAsset | Type_479_DescendOrigin | Type_479_ExchangeAsset | Type_479_ExecuteWithOrigin | Type_479_ExpectAsset | Type_479_ExpectError | Type_479_ExpectOrigin | Type_479_ExpectPallet | Type_479_ExpectTransactStatus | Type_479_ExportMessage | Type_479_HrmpChannelAccepted | Type_479_HrmpChannelClosing | Type_479_HrmpNewChannelOpenRequest | Type_479_InitiateReserveWithdraw | Type_479_InitiateTeleport | Type_479_InitiateTransfer | Type_479_LockAsset | Type_479_NoteUnlockable | Type_479_PayFees | Type_479_QueryPallet | Type_479_QueryResponse | Type_479_ReceiveTeleportedAsset | Type_479_RefundSurplus | Type_479_ReportError | Type_479_ReportHolding | Type_479_ReportTransactStatus | Type_479_RequestUnlock | Type_479_ReserveAssetDeposited | Type_479_SetAppendix | Type_479_SetErrorHandler | Type_479_SetFeesMode | Type_479_SetHints | Type_479_SetTopic | Type_479_SubscribeVersion | Type_479_Transact | Type_479_TransferAsset | Type_479_TransferReserveAsset | Type_479_Trap | Type_479_UniversalOrigin | Type_479_UnlockAsset | Type_479_UnpaidExecution | Type_479_UnsubscribeVersion | Type_479_WithdrawAsset
...
export type Type_476 = Type_476_AliasOrigin | Type_476_BurnAsset | Type_476_BuyExecution | Type_476_ClaimAsset | Type_476_ClearError | Type_476_ClearOrigin | Type_476_ClearTopic | Type_476_ClearTransactStatus | Type_476_DepositAsset | Type_476_DepositReserveAsset | Type_476_DescendOrigin | Type_476_ExchangeAsset | Type_476_ExpectAsset | Type_476_ExpectError | Type_476_ExpectOrigin | Type_476_ExpectPallet | Type_476_ExpectTransactStatus | Type_476_ExportMessage | Type_476_HrmpChannelAccepted | Type_476_HrmpChannelClosing | Type_476_HrmpNewChannelOpenRequest | Type_476_InitiateReserveWithdraw | Type_476_InitiateTeleport | Type_476_LockAsset | Type_476_NoteUnlockable | Type_476_QueryPallet | Type_476_QueryResponse | Type_476_ReceiveTeleportedAsset | Type_476_RefundSurplus | Type_476_ReportError | Type_476_ReportHolding | Type_476_ReportTransactStatus | Type_476_RequestUnlock | Type_476_ReserveAssetDeposited | Type_476_SetAppendix | Type_476_SetErrorHandler | Type_476_SetFeesMode | Type_476_SetTopic | Type_476_SubscribeVersion | Type_476_Transact | Type_476_TransferAsset | Type_476_TransferReserveAsset | Type_476_Trap | Type_476_UniversalOrigin | Type_476_UnlockAsset | Type_476_UnpaidExecution | Type_476_UnsubscribeVersion | Type_476_WithdrawAsset
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type XcmPalletCall = XcmPalletCall_add_authorized_alias | XcmPalletCall_claim_assets | XcmPalletCall_execute | XcmPalletCall_force_default_xcm_version | XcmPalletCall_force_subscribe_version_notify | XcmPalletCall_force_suspension | XcmPalletCall_force_unsubscribe_version_notify | XcmPalletCall_force_xcm_version | XcmPalletCall_limited_reserve_transfer_assets | XcmPalletCall_limited_teleport_assets | XcmPalletCall_remove_all_authorized_aliases | XcmPalletCall_remove_authorized_alias | XcmPalletCall_reserve_transfer_assets | XcmPalletCall_send | XcmPalletCall_teleport_assets | XcmPalletCall_transfer_assets | XcmPalletCall_transfer_assets_using_type_and_then
...
export const Type_165: sts.Type<Type_165> = sts.closedEnum(() => {
    return  {
        Response: V5Location,
        Xcm: V5Location,
    }
...
export type Type_165 = Type_165_Response | Type_165_Xcm

export interface Type_165_Response {
    __kind: 'Response'
    value: V5Location
}

export interface Type_165_Xcm {
    __kind: 'Xcm'
    value: V5Location
}
...
export type Type_163 = Type_163_Parachain

export interface Type_163_Parachain {
    __kind: 'Parachain'
    value: Id
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const StakingAhClientCall: sts.Type<StakingAhClientCall> = sts.closedEnum(() => {
    return  {
        force_on_migration_end: sts.unit(),
        set_mode: sts.enumStruct({
            mode: OperatingMode,
        }),
        validator_set: sts.enumStruct({
            report: ValidatorSetReport,
        }),
    }
})

export const ValidatorSetReport: sts.Type<ValidatorSetReport> = sts.struct(() => {
    return  {
        newValidatorSet: sts.array(() => AccountId32),
        id: sts.number(),
        pruneUpTo: sts.option(() => sts.number()),
        leftover: sts.boolean(),
    }
})

export interface ValidatorSetReport {
    newValidatorSet: AccountId32[]
    id: number
    pruneUpTo?: (number | undefined)
    leftover: boolean
}

export const OperatingMode: sts.Type<OperatingMode> = sts.closedEnum(() => {
    return  {
        Active: sts.unit(),
        Buffered: sts.unit(),
        Passive: sts.unit(),
...
export type OperatingMode = OperatingMode_Active | OperatingMode_Buffered | OperatingMode_Passive

export interface OperatingMode_Active {
    __kind: 'Active'
}

export interface OperatingMode_Buffered {
    __kind: 'Buffered'
}

export interface OperatingMode_Passive {
    __kind: 'Passive'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type StakingAhClientCall = StakingAhClientCall_force_on_migration_end | StakingAhClientCall_set_mode | StakingAhClientCall_validator_set

/**
 * manually do what this pallet was meant to do at the end of the migration.
 */
export interface StakingAhClientCall_force_on_migration_end {
    __kind: 'force_on_migration_end'
}

/**
 * Allows governance to force set the operating mode of the pallet.
 */
export interface StakingAhClientCall_set_mode {
    __kind: 'set_mode'
    mode: OperatingMode
}

export interface StakingAhClientCall_validator_set {
    __kind: 'validator_set'
    report: ValidatorSetReport
}
...
export const StakingCall: sts.Type<StakingCall> = sts.closedEnum(() => {
    return  {
        ...
        set_staking_configs: sts.enumStruct({
            ...
            maxNominatorCount: Type_127,
            maxValidatorCount: Type_127,
            chillThreshold: Type_128,
            minCommission: Type_129,
            maxStakedRewards: Type_128,
        }),
...
export type Type_129 = Type_129_Noop | Type_129_Remove | Type_129_Set
...
export const Type_128: sts.Type<Type_128> = sts.closedEnum(() => {
    return  {
        Noop: sts.unit(),
        Remove: sts.unit(),
        Set: Percent,
...
export type Type_128 = Type_128_Noop | Type_128_Remove | Type_128_Set
 ...
 */
export interface SocietyCall_poke_deposit {
    __kind: 'poke_deposit'
}
...
export const RecoveryCall: sts.Type<RecoveryCall> = sts.closedEnum(() => {
    return  {
        ...
        poke_deposit: sts.enumStruct({
            maybeAccount: sts.option(() => MultiAddress),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type RecoveryCall = RecoveryCall_as_recovered | RecoveryCall_cancel_recovered | RecoveryCall_claim_recovery | RecoveryCall_close_recovery | RecoveryCall_create_recovery | RecoveryCall_initiate_recovery | RecoveryCall_poke_deposit | RecoveryCall_remove_recovery | RecoveryCall_set_recovered | RecoveryCall_vouch_recovery
 ...
 */
export interface RecoveryCall_poke_deposit {
    __kind: 'poke_deposit'
    maybeAccount?: (MultiAddress | undefined)
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const RcMigratorCall: sts.Type<RcMigratorCall> = sts.closedEnum(() => {
    return  {
        cancel_migration: sts.unit(),
        force_set_stage: sts.enumStruct({
            stage: MigrationStage,
        }),
        pause_migration: sts.unit(),
        preserve_accounts: sts.enumStruct({
            accounts: sts.array(() => AccountId32),
        }),
        receive_query_response: sts.enumStruct({
            queryId: sts.bigint(),
            response: V5Response,
        }),
        resend_xcm: sts.enumStruct({
            queryId: sts.bigint(),
        }),
        schedule_migration: sts.enumStruct({
            start: DispatchTime,
            warmUp: DispatchTime,
            coolOff: DispatchTime,
            unsafeIgnoreStakingLockCheck: sts.boolean(),
        }),
        send_xcm_message: sts.enumStruct({
            dest: VersionedLocation,
            message: VersionedXcm,
        }),
        set_ah_ump_queue_priority: sts.enumStruct({
            new: QueuePriority,
        }),
        set_canceller: sts.enumStruct({
            new: sts.option(() => AccountId32),
        }),
        set_manager: sts.enumStruct({
            new: sts.option(() => AccountId32),
        }),
        set_unprocessed_msg_buffer: sts.enumStruct({
            new: sts.option(() => sts.number()),
        }),
        start_data_migration: sts.unit(),
        vote_manager_multisig: sts.enumStruct({
            payload: ManagerMultisigVote,
            sig: MultiSignature,
        }),
    }
})
...
export const ManagerMultisigVote: sts.Type<ManagerMultisigVote> = sts.struct(() => {
    return  {
        who: MultiSigner,
        call: Call,
        round: sts.number(),
...
export interface ManagerMultisigVote {
    who: MultiSigner
    call: Call
    round: number
}

export const QueuePriority: sts.Type<QueuePriority> = sts.closedEnum(() => {
    return  {
        Config: sts.unit(),
        Disabled: sts.unit(),
        OverrideConfig: sts.tuple(() => [sts.number(), sts.number()]),
    }
})

export type QueuePriority = QueuePriority_Config | QueuePriority_Disabled | QueuePriority_OverrideConfig

export interface QueuePriority_Config {
    __kind: 'Config'
}

export interface QueuePriority_Disabled {
    __kind: 'Disabled'
}

export interface QueuePriority_OverrideConfig {
    __kind: 'OverrideConfig'
    value: [number, number]
}

export const MigrationStage: sts.Type<MigrationStage> = sts.closedEnum(() => {
    return  {
        AccountsMigrationDone: sts.unit(),
        AccountsMigrationInit: sts.unit(),
        AccountsMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => AccountId32),
        }),
        AssetRateMigrationDone: sts.unit(),
        AssetRateMigrationInit: sts.unit(),
        AssetRateMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => VersionedLocatableAsset),
        }),
        BagsListMigrationDone: sts.unit(),
        BagsListMigrationInit: sts.unit(),
        BagsListMigrationOngoing: sts.enumStruct({
            nextKey: sts.option(() => BagsListStage),
        }),
        BountiesMigrationDone: sts.unit(),
        BountiesMigrationInit: sts.unit(),
        BountiesMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => BountiesStage),
        }),
        ChildBountiesMigrationDone: sts.unit(),
        ChildBountiesMigrationInit: sts.unit(),
        ChildBountiesMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => ChildBountiesStage),
        }),
        ClaimsMigrationDone: sts.unit(),
        ClaimsMigrationInit: sts.unit(),
        ClaimsMigrationOngoing: sts.enumStruct({
            currentKey: sts.option(() => ClaimsStage),
        }),
        ConvictionVotingMigrationDone: sts.unit(),
        ConvictionVotingMigrationInit: sts.unit(),
        ConvictionVotingMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => ConvictionVotingStage),
        }),
        CoolOff: sts.enumStruct({
            endAt: sts.number(),
        }),
        CrowdloanMigrationDone: sts.unit(),
        CrowdloanMigrationInit: sts.unit(),
        CrowdloanMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => CrowdloanStage),
        }),
        DelegatedStakingMigrationDone: sts.unit(),
        DelegatedStakingMigrationInit: sts.unit(),
        DelegatedStakingMigrationOngoing: sts.enumStruct({
            nextKey: sts.option(() => DelegatedStakingStage),
        }),
        IndicesMigrationDone: sts.unit(),
        IndicesMigrationInit: sts.unit(),
        IndicesMigrationOngoing: sts.enumStruct({
            nextKey: sts.enumOption(() => sts.unit()),
        }),
        MigrationDone: sts.unit(),
        MigrationPaused: sts.unit(),
        MultisigMigrationDone: sts.unit(),
        MultisigMigrationInit: sts.unit(),
        MultisigMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => sts.tuple(() => [AccountId32, sts.bytes()])),
        }),
        NomPoolsMigrationDone: sts.unit(),
        NomPoolsMigrationInit: sts.unit(),
        NomPoolsMigrationOngoing: sts.enumStruct({
            nextKey: sts.option(() => NomPoolsStage),
        }),
        Pending: sts.unit(),
        PreimageMigrationChunksDone: sts.unit(),
        PreimageMigrationChunksOngoing: sts.enumStruct({
            lastKey: sts.option(() => sts.tuple(() => [sts.tuple(() => [H256, sts.number()]), sts.number()])),
        }),
        PreimageMigrationDone: sts.unit(),
        PreimageMigrationInit: sts.unit(),
        PreimageMigrationLegacyRequestStatusDone: sts.unit(),
        PreimageMigrationLegacyRequestStatusInit: sts.unit(),
        PreimageMigrationLegacyRequestStatusOngoing: sts.enumStruct({
            nextKey: sts.option(() => H256),
        }),
        PreimageMigrationRequestStatusDone: sts.unit(),
        PreimageMigrationRequestStatusOngoing: sts.enumStruct({
            nextKey: sts.option(() => H256),
        }),
        ProxyMigrationAnnouncements: sts.enumStruct({
            lastKey: sts.option(() => AccountId32),
        }),
        ProxyMigrationDone: sts.unit(),
        ProxyMigrationInit: sts.unit(),
        ProxyMigrationProxies: sts.enumStruct({
            lastKey: sts.option(() => AccountId32),
        }),
        PureProxyCandidatesMigrationInit: sts.unit(),
        RecoveryMigrationDone: sts.unit(),
        RecoveryMigrationInit: sts.unit(),
        RecoveryMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => RecoveryStage),
        }),
        ReferendaMigrationDone: sts.unit(),
        ReferendaMigrationInit: sts.unit(),
        ReferendaMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => ReferendaStage),
        }),
        Scheduled: sts.enumStruct({
            start: sts.number(),
        }),
        SchedulerAgendaMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => sts.number()),
        }),
        SchedulerMigrationDone: sts.unit(),
        SchedulerMigrationInit: sts.unit(),
        SchedulerMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => SchedulerStage),
        }),
        SignalMigrationFinish: sts.unit(),
        SocietyMigrationDone: sts.unit(),
        SocietyMigrationInit: sts.unit(),
        SocietyMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => SocietyStage),
        }),
        StakingMigrationDone: sts.unit(),
        StakingMigrationInit: sts.unit(),
        StakingMigrationOngoing: sts.enumStruct({
            nextKey: sts.option(() => StakingStage),
        }),
        Starting: sts.unit(),
        TreasuryMigrationDone: sts.unit(),
        TreasuryMigrationInit: sts.unit(),
        TreasuryMigrationOngoing: sts.enumStruct({
            lastKey: sts.option(() => TreasuryStage),
        }),
        VestingMigrationDone: sts.unit(),
        VestingMigrationInit: sts.unit(),
        VestingMigrationOngoing: sts.enumStruct({
            nextKey: sts.option(() => AccountId32),
        }),
        WaitingForAh: sts.unit(),
        WarmUp: sts.enumStruct({
            endAt: sts.number(),
        }),
    }
})

export const TreasuryStage: sts.Type<TreasuryStage> = sts.closedEnum(() => {
    return  {
        Approvals: sts.unit(),
        Finished: sts.unit(),
        Funds: sts.unit(),
        LastSpendPeriod: sts.unit(),
        ProposalCount: sts.unit(),
        Proposals: sts.option(() => sts.number()),
        SpendCount: sts.unit(),
        Spends: sts.option(() => sts.number()),
    }
})

export type TreasuryStage = TreasuryStage_Approvals | TreasuryStage_Finished | TreasuryStage_Funds | TreasuryStage_LastSpendPeriod | TreasuryStage_ProposalCount | TreasuryStage_Proposals | TreasuryStage_SpendCount | TreasuryStage_Spends

export interface TreasuryStage_Approvals {
    __kind: 'Approvals'
}

export interface TreasuryStage_Finished {
    __kind: 'Finished'
}

export interface TreasuryStage_Funds {
    __kind: 'Funds'
}

export interface TreasuryStage_LastSpendPeriod {
    __kind: 'LastSpendPeriod'
}

export interface TreasuryStage_ProposalCount {
    __kind: 'ProposalCount'
}

export interface TreasuryStage_Proposals {
    __kind: 'Proposals'
    value?: (number | undefined)
}

export interface TreasuryStage_SpendCount {
    __kind: 'SpendCount'
}

export interface TreasuryStage_Spends {
    __kind: 'Spends'
    value?: (number | undefined)
}

export const StakingStage: sts.Type<StakingStage> = sts.closedEnum(() => {
    return  {
        Bonded: sts.option(() => AccountId32),
        BondedEras: sts.unit(),
        ClaimedRewards: sts.option(() => sts.tuple(() => [sts.number(), AccountId32])),
        ErasRewardPoints: sts.option(() => sts.number()),
        ErasStakersOverview: sts.option(() => sts.tuple(() => [sts.number(), AccountId32])),
        ErasStakersPaged: sts.option(() => sts.tuple(() => [sts.number(), AccountId32, sts.number()])),
        ErasTotalStake: sts.option(() => sts.number()),
        ErasValidatorPrefs: sts.option(() => sts.tuple(() => [sts.number(), AccountId32])),
        ErasValidatorReward: sts.option(() => sts.number()),
        Finished: sts.unit(),
        Invulnerables: sts.unit(),
        Ledger: sts.option(() => AccountId32),
        NominatorSlashInEra: sts.option(() => sts.tuple(() => [sts.number(), AccountId32])),
        Nominators: sts.option(() => AccountId32),
        Payee: sts.option(() => AccountId32),
        SlashingSpans: sts.option(() => AccountId32),
        SpanSlash: sts.option(() => sts.tuple(() => [AccountId32, sts.number()])),
        UnappliedSlashes: sts.option(() => sts.number()),
        ValidatorSlashInEra: sts.option(() => sts.tuple(() => [sts.number(), AccountId32])),
        Validators: sts.option(() => AccountId32),
        Values: sts.unit(),
        VirtualStakers: sts.option(() => AccountId32),
    }
})

export type StakingStage = StakingStage_Bonded | StakingStage_BondedEras | StakingStage_ClaimedRewards | StakingStage_ErasRewardPoints | StakingStage_ErasStakersOverview | StakingStage_ErasStakersPaged | StakingStage_ErasTotalStake | StakingStage_ErasValidatorPrefs | StakingStage_ErasValidatorReward | StakingStage_Finished | StakingStage_Invulnerables | StakingStage_Ledger | StakingStage_NominatorSlashInEra | StakingStage_Nominators | StakingStage_Payee | StakingStage_SlashingSpans | StakingStage_SpanSlash | StakingStage_UnappliedSlashes | StakingStage_ValidatorSlashInEra | StakingStage_Validators | StakingStage_Values | StakingStage_VirtualStakers

export interface StakingStage_Bonded {
    __kind: 'Bonded'
    value?: (AccountId32 | undefined)
}

export interface StakingStage_BondedEras {
    __kind: 'BondedEras'
}

export interface StakingStage_ClaimedRewards {
    __kind: 'ClaimedRewards'
    value?: ([number, AccountId32] | undefined)
}

export interface StakingStage_ErasRewardPoints {
    __kind: 'ErasRewardPoints'
    value?: (number | undefined)
}

export interface StakingStage_ErasStakersOverview {
    __kind: 'ErasStakersOverview'
    value?: ([number, AccountId32] | undefined)
}

export interface StakingStage_ErasStakersPaged {
    __kind: 'ErasStakersPaged'
    value?: ([number, AccountId32, number] | undefined)
}

export interface StakingStage_ErasTotalStake {
    __kind: 'ErasTotalStake'
    value?: (number | undefined)
}

export interface StakingStage_ErasValidatorPrefs {
    __kind: 'ErasValidatorPrefs'
    value?: ([number, AccountId32] | undefined)
}

export interface StakingStage_ErasValidatorReward {
    __kind: 'ErasValidatorReward'
    value?: (number | undefined)
}

export interface StakingStage_Finished {
    __kind: 'Finished'
}

export interface StakingStage_Invulnerables {
    __kind: 'Invulnerables'
}

export interface StakingStage_Ledger {
    __kind: 'Ledger'
    value?: (AccountId32 | undefined)
}

export interface StakingStage_NominatorSlashInEra {
    __kind: 'NominatorSlashInEra'
    value?: ([number, AccountId32] | undefined)
}

export interface StakingStage_Nominators {
    __kind: 'Nominators'
    value?: (AccountId32 | undefined)
}

export interface StakingStage_Payee {
    __kind: 'Payee'
    value?: (AccountId32 | undefined)
}

export interface StakingStage_SlashingSpans {
    __kind: 'SlashingSpans'
    value?: (AccountId32 | undefined)
}

export interface StakingStage_SpanSlash {
    __kind: 'SpanSlash'
    value?: ([AccountId32, number] | undefined)
}

export interface StakingStage_UnappliedSlashes {
    __kind: 'UnappliedSlashes'
    value?: (number | undefined)
}

export interface StakingStage_ValidatorSlashInEra {
    __kind: 'ValidatorSlashInEra'
    value?: ([number, AccountId32] | undefined)
}

export interface StakingStage_Validators {
    __kind: 'Validators'
    value?: (AccountId32 | undefined)
}

export interface StakingStage_Values {
    __kind: 'Values'
}

export interface StakingStage_VirtualStakers {
    __kind: 'VirtualStakers'
    value?: (AccountId32 | undefined)
}

export const SocietyStage: sts.Type<SocietyStage> = sts.closedEnum(() => {
    return  {
        Candidates: sts.option(() => AccountId32),
        DefenderVotes: sts.option(() => sts.tuple(() => [sts.number(), AccountId32])),
        Finished: sts.unit(),
        MemberByIndex: sts.option(() => sts.number()),
        Members: sts.option(() => AccountId32),
        Payouts: sts.option(() => AccountId32),
        SuspendedMembers: sts.option(() => AccountId32),
        Values: sts.unit(),
        VoteClearCursor: sts.option(() => AccountId32),
        Votes: sts.option(() => sts.tuple(() => [AccountId32, AccountId32])),
    }
})

export type SocietyStage = SocietyStage_Candidates | SocietyStage_DefenderVotes | SocietyStage_Finished | SocietyStage_MemberByIndex | SocietyStage_Members | SocietyStage_Payouts | SocietyStage_SuspendedMembers | SocietyStage_Values | SocietyStage_VoteClearCursor | SocietyStage_Votes

export interface SocietyStage_Candidates {
    __kind: 'Candidates'
    value?: (AccountId32 | undefined)
}

export interface SocietyStage_DefenderVotes {
    __kind: 'DefenderVotes'
    value?: ([number, AccountId32] | undefined)
}

export interface SocietyStage_Finished {
    __kind: 'Finished'
}

export interface SocietyStage_MemberByIndex {
    __kind: 'MemberByIndex'
    value?: (number | undefined)
}

export interface SocietyStage_Members {
    __kind: 'Members'
    value?: (AccountId32 | undefined)
}

export interface SocietyStage_Payouts {
    __kind: 'Payouts'
    value?: (AccountId32 | undefined)
}

export interface SocietyStage_SuspendedMembers {
    __kind: 'SuspendedMembers'
    value?: (AccountId32 | undefined)
}

export interface SocietyStage_Values {
    __kind: 'Values'
}

export interface SocietyStage_VoteClearCursor {
    __kind: 'VoteClearCursor'
    value?: (AccountId32 | undefined)
}

export interface SocietyStage_Votes {
    __kind: 'Votes'
    value?: ([AccountId32, AccountId32] | undefined)
}

export const SchedulerStage: sts.Type<SchedulerStage> = sts.closedEnum(() => {
    return  {
        Finished: sts.unit(),
        IncompleteSince: sts.unit(),
        Lookup: sts.option(() => sts.bytes()),
        Retries: sts.option(() => sts.tuple(() => [sts.number(), sts.number()])),
    }
})

export type SchedulerStage = SchedulerStage_Finished | SchedulerStage_IncompleteSince | SchedulerStage_Lookup | SchedulerStage_Retries

export interface SchedulerStage_Finished {
    __kind: 'Finished'
}

export interface SchedulerStage_IncompleteSince {
    __kind: 'IncompleteSince'
}

export interface SchedulerStage_Lookup {
    __kind: 'Lookup'
    value?: (Bytes | undefined)
}

export interface SchedulerStage_Retries {
    __kind: 'Retries'
    value?: ([number, number] | undefined)
}

export const ReferendaStage: sts.Type<ReferendaStage> = sts.closedEnum(() => {
    return  {
        Metadata: sts.option(() => sts.number()),
        ReferendumInfo: sts.option(() => sts.number()),
        StorageValues: sts.unit(),
    }
})

export type ReferendaStage = ReferendaStage_Metadata | ReferendaStage_ReferendumInfo | ReferendaStage_StorageValues

export interface ReferendaStage_Metadata {
    __kind: 'Metadata'
    value?: (number | undefined)
}

export interface ReferendaStage_ReferendumInfo {
    __kind: 'ReferendumInfo'
    value?: (number | undefined)
}

export interface ReferendaStage_StorageValues {
    __kind: 'StorageValues'
}

export const RecoveryStage: sts.Type<RecoveryStage> = sts.closedEnum(() => {
    return  {
        ActiveRecoveries: sts.option(() => sts.tuple(() => [AccountId32, AccountId32])),
        Finished: sts.unit(),
        Proxy: sts.option(() => AccountId32),
        Recoverable: sts.option(() => AccountId32),
    }
})

export type RecoveryStage = RecoveryStage_ActiveRecoveries | RecoveryStage_Finished | RecoveryStage_Proxy | RecoveryStage_Recoverable

export interface RecoveryStage_ActiveRecoveries {
    __kind: 'ActiveRecoveries'
    value?: ([AccountId32, AccountId32] | undefined)
}

export interface RecoveryStage_Finished {
    __kind: 'Finished'
}

export interface RecoveryStage_Proxy {
    __kind: 'Proxy'
    value?: (AccountId32 | undefined)
}

export interface RecoveryStage_Recoverable {
    __kind: 'Recoverable'
    value?: (AccountId32 | undefined)
}

export const NomPoolsStage: sts.Type<NomPoolsStage> = sts.closedEnum(() => {
    return  {
        BondedPools: sts.option(() => sts.number()),
        ClaimPermissions: sts.option(() => AccountId32),
        Finished: sts.unit(),
        Metadata: sts.option(() => sts.number()),
        PoolMembers: sts.option(() => AccountId32),
        ReversePoolIdLookup: sts.option(() => AccountId32),
        RewardPools: sts.option(() => sts.number()),
        StorageValues: sts.unit(),
        SubPoolsStorage: sts.option(() => sts.number()),
    }
})

export type NomPoolsStage = NomPoolsStage_BondedPools | NomPoolsStage_ClaimPermissions | NomPoolsStage_Finished | NomPoolsStage_Metadata | NomPoolsStage_PoolMembers | NomPoolsStage_ReversePoolIdLookup | NomPoolsStage_RewardPools | NomPoolsStage_StorageValues | NomPoolsStage_SubPoolsStorage

export interface NomPoolsStage_BondedPools {
    __kind: 'BondedPools'
    value?: (number | undefined)
}

export interface NomPoolsStage_ClaimPermissions {
    __kind: 'ClaimPermissions'
    value?: (AccountId32 | undefined)
}

export interface NomPoolsStage_Finished {
    __kind: 'Finished'
}

export interface NomPoolsStage_Metadata {
    __kind: 'Metadata'
    value?: (number | undefined)
}

export interface NomPoolsStage_PoolMembers {
    __kind: 'PoolMembers'
    value?: (AccountId32 | undefined)
}

export interface NomPoolsStage_ReversePoolIdLookup {
    __kind: 'ReversePoolIdLookup'
    value?: (AccountId32 | undefined)
}

export interface NomPoolsStage_RewardPools {
    __kind: 'RewardPools'
    value?: (number | undefined)
}

export interface NomPoolsStage_StorageValues {
    __kind: 'StorageValues'
}

export interface NomPoolsStage_SubPoolsStorage {
    __kind: 'SubPoolsStorage'
    value?: (number | undefined)
}

export const DelegatedStakingStage: sts.Type<DelegatedStakingStage> = sts.closedEnum(() => {
    return  {
        Agents: sts.option(() => AccountId32),
        Delegators: sts.option(() => AccountId32),
        Finished: sts.unit(),
    }
})

export type DelegatedStakingStage = DelegatedStakingStage_Agents | DelegatedStakingStage_Delegators | DelegatedStakingStage_Finished

export interface DelegatedStakingStage_Agents {
    __kind: 'Agents'
    value?: (AccountId32 | undefined)
}

export interface DelegatedStakingStage_Delegators {
    __kind: 'Delegators'
    value?: (AccountId32 | undefined)
}

export interface DelegatedStakingStage_Finished {
    __kind: 'Finished'
}

export const CrowdloanStage: sts.Type<CrowdloanStage> = sts.closedEnum(() => {
    return  {
        CrowdloanContribution: sts.enumStruct({
            lastKey: sts.option(() => Id),
        }),
        CrowdloanReserve: sts.unit(),
        Finished: sts.unit(),
        LeaseReserve: sts.enumStruct({
            lastKey: sts.option(() => Id),
        }),
        Setup: sts.unit(),
    }
...
export type CrowdloanStage = CrowdloanStage_CrowdloanContribution | CrowdloanStage_CrowdloanReserve | CrowdloanStage_Finished | CrowdloanStage_LeaseReserve | CrowdloanStage_Setup

export interface CrowdloanStage_CrowdloanContribution {
    __kind: 'CrowdloanContribution'
    lastKey?: (Id | undefined)
}

export interface CrowdloanStage_CrowdloanReserve {
    __kind: 'CrowdloanReserve'
}

export interface CrowdloanStage_Finished {
    __kind: 'Finished'
}

export interface CrowdloanStage_LeaseReserve {
    __kind: 'LeaseReserve'
    lastKey?: (Id | undefined)
}

export interface CrowdloanStage_Setup {
    __kind: 'Setup'
}

export const ConvictionVotingStage: sts.Type<ConvictionVotingStage> = sts.closedEnum(() => {
    return  {
        ClassLocksFor: sts.option(() => AccountId32),
        Finished: sts.unit(),
        VotingFor: sts.option(() => sts.tuple(() => [AccountId32, sts.number()])),
    }
})

export type ConvictionVotingStage = ConvictionVotingStage_ClassLocksFor | ConvictionVotingStage_Finished | ConvictionVotingStage_VotingFor

export interface ConvictionVotingStage_ClassLocksFor {
    __kind: 'ClassLocksFor'
    value?: (AccountId32 | undefined)
}

export interface ConvictionVotingStage_Finished {
    __kind: 'Finished'
}

export interface ConvictionVotingStage_VotingFor {
    __kind: 'VotingFor'
    value?: ([AccountId32, number] | undefined)
}

export const ClaimsStage: sts.Type<ClaimsStage> = sts.closedEnum(() => {
    return  {
        Claims: sts.option(() => EthereumAddress),
        Finished: sts.unit(),
        Preclaims: sts.option(() => AccountId32),
        Signing: sts.option(() => EthereumAddress),
        StorageValues: sts.unit(),
        Vesting: sts.option(() => EthereumAddress),
    }
})

export const EthereumAddress = sts.bytes()

export type ClaimsStage = ClaimsStage_Claims | ClaimsStage_Finished | ClaimsStage_Preclaims | ClaimsStage_Signing | ClaimsStage_StorageValues | ClaimsStage_Vesting

export interface ClaimsStage_Claims {
    __kind: 'Claims'
    value?: (EthereumAddress | undefined)
}

export interface ClaimsStage_Finished {
    __kind: 'Finished'
}

export interface ClaimsStage_Preclaims {
    __kind: 'Preclaims'
    value?: (AccountId32 | undefined)
}

export interface ClaimsStage_Signing {
    __kind: 'Signing'
    value?: (EthereumAddress | undefined)
}

export interface ClaimsStage_StorageValues {
    __kind: 'StorageValues'
}

export interface ClaimsStage_Vesting {
    __kind: 'Vesting'
    value?: (EthereumAddress | undefined)
}
...
export const ChildBountiesStage: sts.Type<ChildBountiesStage> = sts.closedEnum(() => {
    return  {
        ChildBounties: sts.enumStruct({
            ids: sts.option(() => sts.tuple(() => [sts.number(), sts.number()])),
        }),
        ChildBountyCount: sts.unit(),
        ChildBountyDescriptionsV1: sts.enumStruct({
            ids: sts.option(() => sts.tuple(() => [sts.number(), sts.number()])),
        }),
        ChildrenCuratorFees: sts.enumStruct({
            childId: sts.option(() => sts.number()),
        }),
        Finished: sts.unit(),
        ParentChildBounties: sts.enumStruct({
            parentId: sts.option(() => sts.number()),
        }),
        ParentTotalChildBounties: sts.enumStruct({
            parentId: sts.option(() => sts.number()),
        }),
        V0ToV1ChildBountyIds: sts.enumStruct({
            childId: sts.option(() => sts.number()),
        }),
    }
})

export type ChildBountiesStage = ChildBountiesStage_ChildBounties | ChildBountiesStage_ChildBountyCount | ChildBountiesStage_ChildBountyDescriptionsV1 | ChildBountiesStage_ChildrenCuratorFees | ChildBountiesStage_Finished | ChildBountiesStage_ParentChildBounties | ChildBountiesStage_ParentTotalChildBounties | ChildBountiesStage_V0ToV1ChildBountyIds

export interface ChildBountiesStage_ChildBounties {
    __kind: 'ChildBounties'
    ids?: ([number, number] | undefined)
}

export interface ChildBountiesStage_ChildBountyCount {
    __kind: 'ChildBountyCount'
}

export interface ChildBountiesStage_ChildBountyDescriptionsV1 {
    __kind: 'ChildBountyDescriptionsV1'
    ids?: ([number, number] | undefined)
}

export interface ChildBountiesStage_ChildrenCuratorFees {
    __kind: 'ChildrenCuratorFees'
    childId?: (number | undefined)
}

export interface ChildBountiesStage_Finished {
    __kind: 'Finished'
}

export interface ChildBountiesStage_ParentChildBounties {
    __kind: 'ParentChildBounties'
    parentId?: (number | undefined)
}

export interface ChildBountiesStage_ParentTotalChildBounties {
    __kind: 'ParentTotalChildBounties'
    parentId?: (number | undefined)
}

export interface ChildBountiesStage_V0ToV1ChildBountyIds {
    __kind: 'V0ToV1ChildBountyIds'
    childId?: (number | undefined)
}

export const BountiesStage: sts.Type<BountiesStage> = sts.closedEnum(() => {
    return  {
        Bounties: sts.enumStruct({
            lastKey: sts.option(() => sts.number()),
        }),
        BountyApprovals: sts.unit(),
        BountyCount: sts.unit(),
        BountyDescriptions: sts.enumStruct({
            lastKey: sts.option(() => sts.number()),
        }),
        Finished: sts.unit(),
    }
...
export type BountiesStage = BountiesStage_Bounties | BountiesStage_BountyApprovals | BountiesStage_BountyCount | BountiesStage_BountyDescriptions | BountiesStage_Finished

export interface BountiesStage_Bounties {
    __kind: 'Bounties'
    lastKey?: (number | undefined)
}

export interface BountiesStage_BountyApprovals {
    __kind: 'BountyApprovals'
}

export interface BountiesStage_BountyCount {
    __kind: 'BountyCount'
}

export interface BountiesStage_BountyDescriptions {
    __kind: 'BountyDescriptions'
    lastKey?: (number | undefined)
}

export interface BountiesStage_Finished {
    __kind: 'Finished'
}

export const BagsListStage: sts.Type<BagsListStage> = sts.closedEnum(() => {
    return  {
        Finished: sts.unit(),
        ListBags: sts.option(() => sts.bigint()),
        ListNodes: sts.option(() => AccountId32),
    }
})

export type BagsListStage = BagsListStage_Finished | BagsListStage_ListBags | BagsListStage_ListNodes

export interface BagsListStage_Finished {
    __kind: 'Finished'
}

export interface BagsListStage_ListBags {
    __kind: 'ListBags'
    value?: (bigint | undefined)
}

export interface BagsListStage_ListNodes {
    __kind: 'ListNodes'
    value?: (AccountId32 | undefined)
}

export type MigrationStage = MigrationStage_AccountsMigrationDone | MigrationStage_AccountsMigrationInit | MigrationStage_AccountsMigrationOngoing | MigrationStage_AssetRateMigrationDone | MigrationStage_AssetRateMigrationInit | MigrationStage_AssetRateMigrationOngoing | MigrationStage_BagsListMigrationDone | MigrationStage_BagsListMigrationInit | MigrationStage_BagsListMigrationOngoing | MigrationStage_BountiesMigrationDone | MigrationStage_BountiesMigrationInit | MigrationStage_BountiesMigrationOngoing | MigrationStage_ChildBountiesMigrationDone | MigrationStage_ChildBountiesMigrationInit | MigrationStage_ChildBountiesMigrationOngoing | MigrationStage_ClaimsMigrationDone | MigrationStage_ClaimsMigrationInit | MigrationStage_ClaimsMigrationOngoing | MigrationStage_ConvictionVotingMigrationDone | MigrationStage_ConvictionVotingMigrationInit | MigrationStage_ConvictionVotingMigrationOngoing | MigrationStage_CoolOff | MigrationStage_CrowdloanMigrationDone | MigrationStage_CrowdloanMigrationInit | MigrationStage_CrowdloanMigrationOngoing | MigrationStage_DelegatedStakingMigrationDone | MigrationStage_DelegatedStakingMigrationInit | MigrationStage_DelegatedStakingMigrationOngoing | MigrationStage_IndicesMigrationDone | MigrationStage_IndicesMigrationInit | MigrationStage_IndicesMigrationOngoing | MigrationStage_MigrationDone | MigrationStage_MigrationPaused | MigrationStage_MultisigMigrationDone | MigrationStage_MultisigMigrationInit | MigrationStage_MultisigMigrationOngoing | MigrationStage_NomPoolsMigrationDone | MigrationStage_NomPoolsMigrationInit | MigrationStage_NomPoolsMigrationOngoing | MigrationStage_Pending | MigrationStage_PreimageMigrationChunksDone | MigrationStage_PreimageMigrationChunksOngoing | MigrationStage_PreimageMigrationDone | MigrationStage_PreimageMigrationInit | MigrationStage_PreimageMigrationLegacyRequestStatusDone | MigrationStage_PreimageMigrationLegacyRequestStatusInit | MigrationStage_PreimageMigrationLegacyRequestStatusOngoing | MigrationStage_PreimageMigrationRequestStatusDone | MigrationStage_PreimageMigrationRequestStatusOngoing | MigrationStage_ProxyMigrationAnnouncements | MigrationStage_ProxyMigrationDone | MigrationStage_ProxyMigrationInit | MigrationStage_ProxyMigrationProxies | MigrationStage_PureProxyCandidatesMigrationInit | MigrationStage_RecoveryMigrationDone | MigrationStage_RecoveryMigrationInit | MigrationStage_RecoveryMigrationOngoing | MigrationStage_ReferendaMigrationDone | MigrationStage_ReferendaMigrationInit | MigrationStage_ReferendaMigrationOngoing | MigrationStage_Scheduled | MigrationStage_SchedulerAgendaMigrationOngoing | MigrationStage_SchedulerMigrationDone | MigrationStage_SchedulerMigrationInit | MigrationStage_SchedulerMigrationOngoing | MigrationStage_SignalMigrationFinish | MigrationStage_SocietyMigrationDone | MigrationStage_SocietyMigrationInit | MigrationStage_SocietyMigrationOngoing | MigrationStage_StakingMigrationDone | MigrationStage_StakingMigrationInit | MigrationStage_StakingMigrationOngoing | MigrationStage_Starting | MigrationStage_TreasuryMigrationDone | MigrationStage_TreasuryMigrationInit | MigrationStage_TreasuryMigrationOngoing | MigrationStage_VestingMigrationDone | MigrationStage_VestingMigrationInit | MigrationStage_VestingMigrationOngoing | MigrationStage_WaitingForAh | MigrationStage_WarmUp

export interface MigrationStage_AccountsMigrationDone {
    __kind: 'AccountsMigrationDone'
}

export interface MigrationStage_AccountsMigrationInit {
    __kind: 'AccountsMigrationInit'
}

export interface MigrationStage_AccountsMigrationOngoing {
    __kind: 'AccountsMigrationOngoing'
    lastKey?: (AccountId32 | undefined)
}

export interface MigrationStage_AssetRateMigrationDone {
    __kind: 'AssetRateMigrationDone'
}

export interface MigrationStage_AssetRateMigrationInit {
    __kind: 'AssetRateMigrationInit'
}

export interface MigrationStage_AssetRateMigrationOngoing {
    __kind: 'AssetRateMigrationOngoing'
    lastKey?: (VersionedLocatableAsset | undefined)
}

export interface MigrationStage_BagsListMigrationDone {
    __kind: 'BagsListMigrationDone'
}

export interface MigrationStage_BagsListMigrationInit {
    __kind: 'BagsListMigrationInit'
}

export interface MigrationStage_BagsListMigrationOngoing {
    __kind: 'BagsListMigrationOngoing'
    nextKey?: (BagsListStage | undefined)
}

export interface MigrationStage_BountiesMigrationDone {
    __kind: 'BountiesMigrationDone'
}

export interface MigrationStage_BountiesMigrationInit {
    __kind: 'BountiesMigrationInit'
}

export interface MigrationStage_BountiesMigrationOngoing {
    __kind: 'BountiesMigrationOngoing'
    lastKey?: (BountiesStage | undefined)
}

export interface MigrationStage_ChildBountiesMigrationDone {
    __kind: 'ChildBountiesMigrationDone'
}

export interface MigrationStage_ChildBountiesMigrationInit {
    __kind: 'ChildBountiesMigrationInit'
}

export interface MigrationStage_ChildBountiesMigrationOngoing {
    __kind: 'ChildBountiesMigrationOngoing'
    lastKey?: (ChildBountiesStage | undefined)
}

export interface MigrationStage_ClaimsMigrationDone {
    __kind: 'ClaimsMigrationDone'
}

export interface MigrationStage_ClaimsMigrationInit {
    __kind: 'ClaimsMigrationInit'
}

export interface MigrationStage_ClaimsMigrationOngoing {
    __kind: 'ClaimsMigrationOngoing'
    currentKey?: (ClaimsStage | undefined)
}

export interface MigrationStage_ConvictionVotingMigrationDone {
    __kind: 'ConvictionVotingMigrationDone'
}

export interface MigrationStage_ConvictionVotingMigrationInit {
    __kind: 'ConvictionVotingMigrationInit'
}

export interface MigrationStage_ConvictionVotingMigrationOngoing {
    __kind: 'ConvictionVotingMigrationOngoing'
    lastKey?: (ConvictionVotingStage | undefined)
}

export interface MigrationStage_CoolOff {
    __kind: 'CoolOff'
    endAt: number
}

export interface MigrationStage_CrowdloanMigrationDone {
    __kind: 'CrowdloanMigrationDone'
}

export interface MigrationStage_CrowdloanMigrationInit {
    __kind: 'CrowdloanMigrationInit'
}

export interface MigrationStage_CrowdloanMigrationOngoing {
    __kind: 'CrowdloanMigrationOngoing'
    lastKey?: (CrowdloanStage | undefined)
}

export interface MigrationStage_DelegatedStakingMigrationDone {
    __kind: 'DelegatedStakingMigrationDone'
}

export interface MigrationStage_DelegatedStakingMigrationInit {
    __kind: 'DelegatedStakingMigrationInit'
}

export interface MigrationStage_DelegatedStakingMigrationOngoing {
    __kind: 'DelegatedStakingMigrationOngoing'
    nextKey?: (DelegatedStakingStage | undefined)
}

export interface MigrationStage_IndicesMigrationDone {
    __kind: 'IndicesMigrationDone'
}

export interface MigrationStage_IndicesMigrationInit {
    __kind: 'IndicesMigrationInit'
}

export interface MigrationStage_IndicesMigrationOngoing {
    __kind: 'IndicesMigrationOngoing'
    nextKey: Option<null>
}

export interface MigrationStage_MigrationDone {
    __kind: 'MigrationDone'
}

export interface MigrationStage_MigrationPaused {
    __kind: 'MigrationPaused'
}

export interface MigrationStage_MultisigMigrationDone {
    __kind: 'MultisigMigrationDone'
}

export interface MigrationStage_MultisigMigrationInit {
    __kind: 'MultisigMigrationInit'
}

export interface MigrationStage_MultisigMigrationOngoing {
    __kind: 'MultisigMigrationOngoing'
    lastKey?: ([AccountId32, Bytes] | undefined)
}

export interface MigrationStage_NomPoolsMigrationDone {
    __kind: 'NomPoolsMigrationDone'
}

export interface MigrationStage_NomPoolsMigrationInit {
    __kind: 'NomPoolsMigrationInit'
}

export interface MigrationStage_NomPoolsMigrationOngoing {
    __kind: 'NomPoolsMigrationOngoing'
    nextKey?: (NomPoolsStage | undefined)
}

export interface MigrationStage_Pending {
    __kind: 'Pending'
}

export interface MigrationStage_PreimageMigrationChunksDone {
    __kind: 'PreimageMigrationChunksDone'
}

export interface MigrationStage_PreimageMigrationChunksOngoing {
    __kind: 'PreimageMigrationChunksOngoing'
    lastKey?: ([[H256, number], number] | undefined)
}

export interface MigrationStage_PreimageMigrationDone {
    __kind: 'PreimageMigrationDone'
}

export interface MigrationStage_PreimageMigrationInit {
    __kind: 'PreimageMigrationInit'
}

export interface MigrationStage_PreimageMigrationLegacyRequestStatusDone {
    __kind: 'PreimageMigrationLegacyRequestStatusDone'
}

export interface MigrationStage_PreimageMigrationLegacyRequestStatusInit {
    __kind: 'PreimageMigrationLegacyRequestStatusInit'
}

export interface MigrationStage_PreimageMigrationLegacyRequestStatusOngoing {
    __kind: 'PreimageMigrationLegacyRequestStatusOngoing'
    nextKey?: (H256 | undefined)
}

export interface MigrationStage_PreimageMigrationRequestStatusDone {
    __kind: 'PreimageMigrationRequestStatusDone'
}

export interface MigrationStage_PreimageMigrationRequestStatusOngoing {
    __kind: 'PreimageMigrationRequestStatusOngoing'
    nextKey?: (H256 | undefined)
}

export interface MigrationStage_ProxyMigrationAnnouncements {
    __kind: 'ProxyMigrationAnnouncements'
    lastKey?: (AccountId32 | undefined)
}

export interface MigrationStage_ProxyMigrationDone {
    __kind: 'ProxyMigrationDone'
}

export interface MigrationStage_ProxyMigrationInit {
    __kind: 'ProxyMigrationInit'
}

export interface MigrationStage_ProxyMigrationProxies {
    __kind: 'ProxyMigrationProxies'
    lastKey?: (AccountId32 | undefined)
}

export interface MigrationStage_PureProxyCandidatesMigrationInit {
    __kind: 'PureProxyCandidatesMigrationInit'
}

export interface MigrationStage_RecoveryMigrationDone {
    __kind: 'RecoveryMigrationDone'
}

export interface MigrationStage_RecoveryMigrationInit {
    __kind: 'RecoveryMigrationInit'
}

export interface MigrationStage_RecoveryMigrationOngoing {
    __kind: 'RecoveryMigrationOngoing'
    lastKey?: (RecoveryStage | undefined)
}

export interface MigrationStage_ReferendaMigrationDone {
    __kind: 'ReferendaMigrationDone'
}

export interface MigrationStage_ReferendaMigrationInit {
    __kind: 'ReferendaMigrationInit'
}

export interface MigrationStage_ReferendaMigrationOngoing {
    __kind: 'ReferendaMigrationOngoing'
    lastKey?: (ReferendaStage | undefined)
}

export interface MigrationStage_Scheduled {
    __kind: 'Scheduled'
    start: number
}

export interface MigrationStage_SchedulerAgendaMigrationOngoing {
    __kind: 'SchedulerAgendaMigrationOngoing'
    lastKey?: (number | undefined)
}

export interface MigrationStage_SchedulerMigrationDone {
    __kind: 'SchedulerMigrationDone'
}

export interface MigrationStage_SchedulerMigrationInit {
    __kind: 'SchedulerMigrationInit'
}

export interface MigrationStage_SchedulerMigrationOngoing {
    __kind: 'SchedulerMigrationOngoing'
    lastKey?: (SchedulerStage | undefined)
}

export interface MigrationStage_SignalMigrationFinish {
    __kind: 'SignalMigrationFinish'
}

export interface MigrationStage_SocietyMigrationDone {
    __kind: 'SocietyMigrationDone'
}

export interface MigrationStage_SocietyMigrationInit {
    __kind: 'SocietyMigrationInit'
}

export interface MigrationStage_SocietyMigrationOngoing {
    __kind: 'SocietyMigrationOngoing'
    lastKey?: (SocietyStage | undefined)
}

export interface MigrationStage_StakingMigrationDone {
    __kind: 'StakingMigrationDone'
}

export interface MigrationStage_StakingMigrationInit {
    __kind: 'StakingMigrationInit'
}

export interface MigrationStage_StakingMigrationOngoing {
    __kind: 'StakingMigrationOngoing'
    nextKey?: (StakingStage | undefined)
}

export interface MigrationStage_Starting {
    __kind: 'Starting'
}

export interface MigrationStage_TreasuryMigrationDone {
    __kind: 'TreasuryMigrationDone'
}

export interface MigrationStage_TreasuryMigrationInit {
    __kind: 'TreasuryMigrationInit'
}

export interface MigrationStage_TreasuryMigrationOngoing {
    __kind: 'TreasuryMigrationOngoing'
    lastKey?: (TreasuryStage | undefined)
}

export interface MigrationStage_VestingMigrationDone {
    __kind: 'VestingMigrationDone'
}

export interface MigrationStage_VestingMigrationInit {
    __kind: 'VestingMigrationInit'
}

export interface MigrationStage_VestingMigrationOngoing {
    __kind: 'VestingMigrationOngoing'
    nextKey?: (AccountId32 | undefined)
}

export interface MigrationStage_WaitingForAh {
    __kind: 'WaitingForAh'
}

export interface MigrationStage_WarmUp {
    __kind: 'WarmUp'
    endAt: number
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type RcMigratorCall = RcMigratorCall_cancel_migration | RcMigratorCall_force_set_stage | RcMigratorCall_pause_migration | RcMigratorCall_preserve_accounts | RcMigratorCall_receive_query_response | RcMigratorCall_resend_xcm | RcMigratorCall_schedule_migration | RcMigratorCall_send_xcm_message | RcMigratorCall_set_ah_ump_queue_priority | RcMigratorCall_set_canceller | RcMigratorCall_set_manager | RcMigratorCall_set_unprocessed_msg_buffer | RcMigratorCall_start_data_migration | RcMigratorCall_vote_manager_multisig
 ...
 */
export interface RcMigratorCall_cancel_migration {
    __kind: 'cancel_migration'
}
 ...
 * [`Config::AdminOrigin`].
 */
export interface RcMigratorCall_force_set_stage {
    __kind: 'force_set_stage'
    stage: MigrationStage
}
 ...
 * Pause the migration.
 */
export interface RcMigratorCall_pause_migration {
    __kind: 'pause_migration'
}
 ...
 */
export interface RcMigratorCall_preserve_accounts {
    __kind: 'preserve_accounts'
 ...
 */
export interface RcMigratorCall_receive_query_response {
    __kind: 'receive_query_response'
    queryId: bigint
    response: V5Response
}
 ...
 */
export interface RcMigratorCall_resend_xcm {
    __kind: 'resend_xcm'
    queryId: bigint
}
 ...
 */
export interface RcMigratorCall_schedule_migration {
    __kind: 'schedule_migration'
    start: DispatchTime
    warmUp: DispatchTime
    coolOff: DispatchTime
 ...
 * the migration.
 */
export interface RcMigratorCall_send_xcm_message {
    __kind: 'send_xcm_message'
    dest: VersionedLocation
    message: VersionedXcm
}
 ...
 */
export interface RcMigratorCall_set_ah_ump_queue_priority {
    __kind: 'set_ah_ump_queue_priority'
    new: QueuePriority
}
 ...
 */
export interface RcMigratorCall_set_canceller {
    __kind: 'set_canceller'
 ...
 */
export interface RcMigratorCall_set_manager {
    __kind: 'set_manager'
    new?: (AccountId32 | undefined)
}
 ...
 */
export interface RcMigratorCall_set_unprocessed_msg_buffer {
    __kind: 'set_unprocessed_msg_buffer'
 ...
 * migration data.
 */
export interface RcMigratorCall_start_data_migration {
    __kind: 'start_data_migration'
}
 ...
 */
export interface RcMigratorCall_vote_manager_multisig {
    __kind: 'vote_manager_multisig'
    payload: ManagerMultisigVote
    sig: MultiSignature
}
...
export type DisputeOffenceKind = DisputeOffenceKind_AgainstValid | DisputeOffenceKind_ForInvalidApproved | DisputeOffenceKind_ForInvalidBacked
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type ParasCall = ParasCall_add_trusted_validation_code | ParasCall_apply_authorized_force_set_current_code | ParasCall_authorize_force_set_current_code_hash | ParasCall_force_note_new_head | ParasCall_force_queue_action | ParasCall_force_schedule_code_upgrade | ParasCall_force_set_current_code | ParasCall_force_set_current_head | ParasCall_force_set_most_recent_context | ParasCall_include_pvf_check_statement | ParasCall_poke_unused_validation_code | ParasCall_remove_upgrade_cooldown
...
export type Type_182 = Type_182_BurnDestination | Type_182_BurnPortion

export interface Type_182_BurnDestination {
    __kind: 'BurnDestination'
    value: [BurnDestination, Option<BurnDestinationAccount>]
}

export interface Type_182_BurnPortion {
    __kind: 'BurnPortion'
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type OnDemandAssignmentProviderCall = OnDemandAssignmentProviderCall_place_order_allow_death | OnDemandAssignmentProviderCall_place_order_keep_alive | OnDemandAssignmentProviderCall_place_order_with_credits
...
export const NominationPoolsCall: sts.Type<NominationPoolsCall> = sts.closedEnum(() => {
    return  {
        ...
        set_configs: sts.enumStruct({
            minJoinBond: Type_306,
            minCreateBond: Type_306,
            maxPools: Type_307,
            maxMembers: Type_307,
            maxMembersPerPool: Type_307,
            globalMaxCommission: Type_308,
        }),
        set_metadata: sts.enumStruct({
            poolId: sts.number(),
            metadata: sts.bytes(),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type IndicesCall = IndicesCall_claim | IndicesCall_force_transfer | IndicesCall_free | IndicesCall_freeze | IndicesCall_poke_deposit | IndicesCall_transfer
 ...
 * Emits `DepositPoked` if successful.
 */
export interface IndicesCall_poke_deposit {
    __kind: 'poke_deposit'
    index: number
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type CoretimeCall = CoretimeCall_assign_core | CoretimeCall_credit_account | CoretimeCall_request_core_count | CoretimeCall_request_revenue_at
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type BountiesCall = BountiesCall_accept_curator | BountiesCall_approve_bounty | BountiesCall_approve_bounty_with_curator | BountiesCall_award_bounty | BountiesCall_claim_bounty | BountiesCall_close_bounty | BountiesCall_extend_bounty_expiry | BountiesCall_poke_deposit | BountiesCall_propose_bounty | BountiesCall_propose_curator | BountiesCall_unassign_curator
...
export type Call = Call_AssetRate | Call_Auctions | Call_Babe | Call_Balances | Call_Beefy | Call_Bounties | Call_ChildBounties | Call_Claims | Call_Configuration | Call_ConvictionVoting | Call_Coretime | Call_Crowdloan | Call_ElectionProviderMultiPhase | Call_FastUnstake | Call_FellowshipCollective | Call_FellowshipReferenda | Call_Grandpa | Call_Hrmp | Call_Indices | Call_Initializer | Call_MessageQueue | Call_Multisig | Call_NominationPools | Call_OnDemandAssignmentProvider | Call_ParaInclusion | Call_ParaInherent | Call_Parameters | Call_Paras | Call_ParasDisputes | Call_ParasShared | Call_ParasSlashing | Call_Preimage | Call_Proxy | Call_RcMigrator | Call_Recovery | Call_Referenda | Call_Registrar | Call_Scheduler | Call_Session | Call_Slots | Call_Society | Call_Staking | Call_StakingAhClient | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_VoterList | Call_Whitelist | Call_XcmPallet
...
export interface Call_RcMigrator {
    __kind: 'RcMigrator'
    value: RcMigratorCall
}
...
export interface Call_StakingAhClient {
    __kind: 'StakingAhClient'
    value: StakingAhClientCall
}
